    ...
    return (
        <div className='header-container'>
            ...
            <div className='flex flex-row'>
                ...
                <div className='label-container'>
                    <img className="icon" src="https://uploads-ssl.webflow.com/65384f64fc0a1608e6828a1c/6639b31899c525332fee94c4_salida-de-emergencia.png" alt="Log Out" onClick={() => Logout}/>
                </div>
            </div>
        </div>
    );
